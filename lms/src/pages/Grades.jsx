...
const Grades = () => {
  ...
  const highGrades = grades.filter(
    (g) => g.letterGrade === "A" || g.letterGrade === "B"
  ).length;
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {grades.map((grade) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span
                      className={`px-3 py-1 inline-flex text-sm leading-5 font-semibold rounded-full ${getGradeColor(
                        grade.letterGrade
                      )}`}
                    >
        ...
        {grades.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600">
              Your grades will appear here once assignments are
              graded.
            </p>
          </div>
        )}
