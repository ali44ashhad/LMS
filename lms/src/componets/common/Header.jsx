        ...
        <div className="flex justify-between items-center h-14 md:h-16">
          ...
          <div className="flex items-center space-x-2 md:space-x-4">
            ...
            <div className="relative ">
              ...
              >
                <div className="h-7 w-7 md:h-8 md:w-8 rounded-full bg-slate-900/80 border border-cyan-400/60 flex items-center justify-center shadow-[0_0_10px_rgba(0,195,221,0.6)]">
