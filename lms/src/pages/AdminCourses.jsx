...
const AdminCourses = ({ onCreateNew, onEdit }) => {
  ...
  const handleTogglePublish = async (courseId, currentStatus) => {
    try {
      await adminAPI.updateCoursePublishStatus(courseId, !currentStatus);
      fetchCourses();
    } catch (error) {
          ...
          {courses.map((course) => {
            ...
            >
              ...
              <div className="flex items-start justify-between mb-4 gap-4">
                ...
                <button
                  onClick={() =>
                    handleTogglePublish(courseId, isPublished)
                  }
                  className={`
              ...
              <div className="flex flex-wrap gap-2 mb-4 text-xs">
                ...
                >
                  {isPublished ? "Live in Catalog" : "Draft Mode"}
                </span>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4 mb-4 text-xs md:text-sm">
                ...
                <div>
                  ...
                  <p className="font-semibold text-slate-700">
                    {course.enrolled_students ?? course.enrolledStudents ?? 0}
                  </p>
                </div>
              </div>
